...
* New: Content Sync CLI can project allowlisted posts and declared postmeta references to portable files and apply them across environments with stable UIDs
