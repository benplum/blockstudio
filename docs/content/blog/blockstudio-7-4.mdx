...
description: Page collections, Markdown page sources, Content Sync, block tag namespace prefixes, and editor/runtime fixes.
date: 2026-06-21
author: Dennis
---

Blockstudio 7.4 is about making file-backed projects more portable. The release
adds page collections for docs-style sites, Markdown page sources, Content Sync
for selected WordPress content, and targeted authoring/runtime fixes that came
directly from real project usage.
