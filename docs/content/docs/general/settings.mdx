...
| `authors`                | string  | `"ignore"`                               | Author portability mode                                   |
...
| `taxonomies`             | array   | `[]`                                     | Reserved allowlist for term and relationship sync phases  |
...
[Content Sync](/docs/pages-and-patterns/content-sync) for the workflow and file
format.
