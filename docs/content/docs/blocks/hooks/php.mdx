...
This filter lets you register prefix to namespace shorthands for block tags.
Each key is a lowercase prefix without dashes. Each value can be a namespace
string or an ordered list of namespaces.
