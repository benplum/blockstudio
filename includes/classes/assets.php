...
class Assets {
	...
	public function maybe_reset_editor_styles( array $settings ): array {
		...
		if ( Settings::get( 'blockEditor/enhance' ) && ! str_contains( $settings['__unstableResolvedAssets']['styles'], 'blockstudio-editor-enhance' ) ) {
			$settings['__unstableResolvedAssets']['styles'] .= '<style id="blockstudio-editor-enhance">html.blockstudio-editor-enhance-locked{overflow:hidden!important}body.blockstudio-editor-enhance-locked{position:fixed!important;inset:0!important;width:100%!important;overflow:hidden!important}.editor-styles-wrapper .blockstudio-block{transition:opacity .25s ease}.editor-styles-wrapper.blockstudio-editor-enhance-pending:not(.blockstudio-editor-enhance-ready) .blockstudio-block{visibility:hidden;opacity:0;pointer-events:none}body.blockstudio-editor-enhance-pending:not(.blockstudio-editor-enhance-ready)::before{content:"";position:fixed;top:50%;left:50%;width:24px;height:24px;margin:-12px 0 0 -12px;border:2px solid rgb(142 142 142 / .35);border-top-color:#7c3aed;border-radius:9999px;opacity:1;transition:opacity .25s ease;animation:blockstudio-editor-enhance-spin .8s linear infinite;z-index:9999}body.blockstudio-editor-enhance-pending.blockstudio-editor-enhance-ready::before{opacity:0}@keyframes blockstudio-editor-enhance-spin{to{transform:rotate(360deg)}}.editor-styles-wrapper :where(.wp-block,.blockstudio-block,.block-editor-rich-text__editable):focus,.editor-styles-wrapper :where(.wp-block,.blockstudio-block,.block-editor-rich-text__editable):focus-visible{outline:none!important;box-shadow:none}.editor-styles-wrapper :where(.wp-block,.blockstudio-block){position:relative}.editor-styles-wrapper :where(.wp-block,.blockstudio-block).is-hovered:not(.has-child-selected)::after,.editor-styles-wrapper :where(.wp-block,.blockstudio-block).is-highlighted:not(.has-child-selected)::after,.editor-styles-wrapper :where(.wp-block,.blockstudio-block).is-selected::after{content:"";position:absolute;inset:0;border:1px solid rgb(142 142 142 / .65);border-radius:inherit;pointer-events:none;z-index:1}.editor-styles-wrapper :where(.wp-block,.blockstudio-block).is-selected::after{border-color:#7c3aed}</style>';
		}
